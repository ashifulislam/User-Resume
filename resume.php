    ...
    <body>
        <div class="maincontent">
            ...
            <div class="left_content">
                <div class="surname">
                    <div class="propic">
                        <img src="img/propic.JPG" alt="" class="profilepicture" >
                    </div>
                    <div class="names">
                        <h1>Ashiful Islam Prince</h1>
                        <h2>Prince</h2>
                        <P>WEB DEVELOPER</P>
                    </div>
                </div>
                ...
                <div class="contact">
                    ...
                    <div class="Cdes">
                        ...
                        <div class="c_right">
                            <p>West rajabazar, Tejgaon,Dhaka</p>
                            <p>princeashifulislam@gmail.com</p>
                            <p>01923867522</p>
                           <p><a href="https://sites.google.com/diu.edu.bd/ashiful-islam-prince/home">prince.com</a></p>
                        </div>
                    </div>
                </div>
                <div class="skills">
            ...
            <div class="right_content">
                <div class="education">
                    ...
                    <div class="edu_des">
                        ...
                        <div class="Enames">
                            <h1>SSC <span>// JAN 2010 - DEC 2014</span></h1>
                            <h1>School Name</h1>
                            <p>Kalikaproshad High School</p>
                        </div>
                        <div class="right_blackdots">
                            <img src="img/black-dot.png" alt="" class="blackdots">
                        </div>
                        <div class="Enames">
                            <h1>HSC <span>// JAN 2014 - Jun 2016</span></h1>
                            <h1>College Name</h1>
                            <p>Haji Asmat College,Bhariab,Kishoregonj</p>
                        </div>
                        <div class="right_blackdots">
                            <img src="img/black-dot.png" alt="" class="blackdots">
                        </div>
                        <div class="Enames">
                            <h1>BSC <span>// Continue</span></h1>
